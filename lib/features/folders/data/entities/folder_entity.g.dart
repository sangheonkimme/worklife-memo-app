...
extension FolderEntityQuerySortBy
  ...
  QueryBuilder<FolderEntity, FolderEntity, QAfterSortBy> sortBySortOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortOrder', Sort.asc);
    });
  }

  QueryBuilder<FolderEntity, FolderEntity, QAfterSortBy> sortBySortOrderDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension FolderEntityQuerySortThenBy
  ...
  QueryBuilder<FolderEntity, FolderEntity, QAfterSortBy> thenBySortOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortOrder', Sort.asc);
    });
  }

  QueryBuilder<FolderEntity, FolderEntity, QAfterSortBy> thenBySortOrderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortOrder', Sort.desc);
    });
  }
...
extension FolderEntityQueryWhereDistinct
  ...
  QueryBuilder<FolderEntity, FolderEntity, QDistinct> distinctBySortOrder() {
    return QueryBuilder.apply(this, (query) {
...
extension FolderEntityQueryProperty
  ...
  QueryBuilder<FolderEntity, int, QQueryOperations> sortOrderProperty() {
    return QueryBuilder.apply(this, (query) {
